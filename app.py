...
with tabs[1]:
    ...
    SELECT Name, Type AS Provider_Type, Address, Contact
...
with tabs[5]:
    ...
    with crud_tabs:
        ...
        if st.button("Add Listing"):
            ...
            try:
                ...
                food_id = int(df_next["next_id"].iloc)
        ...
        if df_food.empty or df_recv.empty:
            ...
            if st.button("Add Claim"):
                ...
                try:
                    ...
                    claim_id = int(df_next["next_id"].iloc)
    ...
    with crud_tabs[3]:
        ...
        if df.empty:
            ...
            claim_id = int(row.split("–").replace("Claim", "").strip())
